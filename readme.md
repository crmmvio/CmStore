# ** CmStore - Aplicação de Mini Loja Simples com MVC e API RESTful**

## **1. Apresentação**

Bem-vindo ao repositório do projeto ** CmStore **. Este projeto é uma entrega do MBA DevXpert Full Stack .NET e é referente ao módulo **Introdução ao Desenvolvimento ASP.NET Core**.
...
- src/
  - CmStore.UI/ - Projeto MVC
  - CmStore.Api/ - API RESTful
  - CmStore.Data/ - Modelos de Dados e Configuração do EF Core
  - CmStore.Domain/ - Lógica de Negócio e Regras de Validação 
...
1. **Clone o Repositório:**
   - `git clone https://github.com/crmmvio/CmStore.git`
   - `cd CmStore`
